...
const LETTER_BY_RELATION = {
  lover: {
    warm: [
      g => `不是生日不是纪念日,只是在别的地方看到这件${g},心里出现了你的名字。`,
      g => `这件${g}给你。该说的话都装进去了,你拆开就能听见。`,
      g => `最近老在想,能为你做点什么。想来想去,先从这件${g}开始吧。`,
      g => `送你一件${g}。不是什么大事,只是想让你知道,你被认真看过。`,
      g => `人都说亲密关系里最难的是“看见”。这件${g},是我看见你了。`,
      g => `你最近不太在状态,我都看在眼里。这件${g},希望能让你软一点点。`,
      g => `说不出口的那些都先放着。先把这件${g}给你。`,
    ],
    witty: [
      g => `为了送你这件${g},我不但研究了你,还研究了我自己的钱包。都不容易。`,
      g => `别说我不浪漫。这件${g}是我加班之余偏偏点开了三个购物车才选出来的。`,
      g => `事先声明:这件${g}没有附赠“随叫随到”服务。但你当然可以试试。`,
      g => `你上次说事后纪念品可以不用贵但要走心。好,${g}安排上了,走的什么心你自己猜。`,
      g => `这件${g}你要是不喜欢,反正退不了了——收收心吧。`,
      g => `送出这件${g}之后,我这个月的浪漫额度已经用完了。有事请调拨下周。`,
      g => `这件${g}是给你的。请不要在意它的吊牌——更不要在意上面那个数字。`,
    ],
  },
  friend: {
    warm: [
      g => `看到这件${g}的时候,第一个想到的就是你。`,
      g => `不是什么大礼,只是那东西出现的时候,我觉得它是为你留着的——这件${g}。`,
      g => `我们认识这么久了,送礼这件事我还会紧张。这件${g}你仔细看看,喜不喜欢跟我说。`,
      g => `送你这件${g}。你那些口头上不会讲的事,我只是听进去了而已。`,
      g => `这件${g}是个说出口就平平无奇、不说又太可惜的意思:我希望你过得好。`,
      g => `别谢。够熟了才能送这件${g}——换别人我还拿不准呢。`,
      g => `都是成年人了,在朋友里被记住是件不容易的事。这件${g}送你,别客气。`,
      g => `这件${g}给你。不为了什么场合,只是觉得到了一个该送你点东西的时候。`,
    ],
    witty: [
      g => `这件${g}送你。不准转赠,不准退货,不准抱怨颜色。有意见请出示另一件同价位礼物。`,
      g => `我会送这件${g},是因为上次你随口一句话被我记住了。下次谨言。`,
      g => `根据你本人提供的口供,你应该会喜欢这件${g}。如果不喜欢——你自己负责。`,
      g => `我是这样想的:送贵的我心疼,送便宜的你嫌弃。最后选了这件${g},别问多少钱。`,
      g => `这件${g}送你。反正说了你也不听,是时候逼你现场拆包装了。`,
      g => `独家合作:我负责付钱,你负责拿到这件${g}后帮我夸一下我的眼光。`,
      g => `别谢,但记账。下次饭局,你请。`,
      g => `本来想写张卡片的,写到一半发现这件${g}已经说完了。`,
    ],
  },
  family: {
    warm: [
      g => `这件${g}。不是什么重要日子,也不为了说什么,只是想让你用上。`,
      g => `看到这件${g}的时候就想,你肯定又会说“买这个干嘛”。但我还是买了。`,
      g => `你口口声声说什么都不要,我都记下来了。今年,先从这件${g}开始。`,
      g => `送你这件${g}。别舍不得,别收起来放柜子里。是要用的。`,
      g => `隔得这么远,能送到你手里的东西不多。这件${g}是其中一件。`,
      g => `你不说,我偶尔也能猜到。这件${g}应该能填上你最近那个“不重要”的小愿望。`,
      g => `寄给你这件${g}。你那头收到了,记得回我一句话就行。`,
    ],
    witty: [
      g => `别问多少钱。这件${g}你用上了,就是对我最好的回报。`,
      g => `这件${g}送你。下次见面不准再说“别买”。`,
      g => `你反正又会客客气气一通。所以我提前把${g}送了、话也说了,你负责使用就行。`,
      g => `这件${g}不能折算成现金,不能转送邻居,你只能自己用。`,
      g => `别老叫我多学习,我也会送礼了。证据在此,${g}。`,
      g => `你退不了——我起码在送礼这件事上比你有远见。`,
      g => `这件${g}是给你的。下次再听见“浪费钱”三个字,我可生气了。`,
    ],
  },
  colleague: {
    warm: [
      g => `一点心意。这件${g}你看能不能用上,用不上也没关系。`,
      g => `听说你最近忙着那个大 case。这件${g}帮不上忙,但愿意能让你中间这段过得舒服些。`,
      g => `同事一场,有些话不好说。这件${g}当我说了一句“辛苦了”。`,
      g => `这件${g}是谢你上次接住我那个活儿。不贵,只是顺手。`,
      g => `共事一场,谢谢。这件${g}请收下。`,
      g => `偏选了这件${g}——不太贵,也不太轻,你看着收。`,
    ],
    witty: [
      g => `只是个小东西。${g}你能收,能送人,也能拿着碎碎念“这人怎么送这个”五分钟。`,
      g => `送你这件${g}。不包括继续加班,不包括减肥,不包括职场未来。`,
      g => `这件${g}是“同事送礼”该有的样子:不贵、不闹、不留话柄。收下吧。`,
      g => `他们说同事不适合送太个人的东西。于是我送了一件${g},仅供工作日使用。`,
      g => `这件${g}装进礼盒有点重,但绝对不会重过你工位上那堆东西。拿去。`,
      g => `送礼如发邮件,简洁就是力量。这件${g},祝周一愉快。`,
    ],
  },
  crush: {
    warm: [
      g => `这件${g}送你。不是什么表白,只是什么都不说也太可惜。`,
      g => `记得你随口提了一句。这件${g}是那句话后面的默默一步。`,
      g => `他们说这个距离最难拿捏,送贵了吓人,送轻了心虚。这件${g}希望刚刚好。`,
      g => `不是什么贵重的东西,但出现在你面前是被想过不止一次的。这件${g}交给你。`,
      g => `这是别人不太好开口、只能由我送的那种礼物。这件${g}。`,
      g => `送你这件${g}。不需要回礼,但如果你愿意说一句“喜欢”,我会在心里双手接住。`,
      g => `想了很久要不要送。最后还是放进了袋子里,这件${g}。`,
    ],
    witty: [
      g => `事先声明:这件${g}与我本人是两件东西。喜欢哪个你自己选。`,
      g => `送你这件${g}。重点不是这件礼物,是“我、记住了、你说过”这三件事。别问太多。`,
      g => `本来只是随便看看,看着看着就买了这件${g}。你别多想。(可以多想一点。)`,
      g => `这件${g}采购过程中咨询了闺蜜、查了你的星座、看了三十条评论。请务必喜欢。`,
      g => `说是顺手买的。顺了一个多月的手。`,
      g => `这件${g}交给你。谢谢你什么都不问。`,
      g => `把这件${g}递给你的瞬间,我会装作非常自然。请你也装作非常自然。`,
    ],
  },
};
...
const ECHO_SCENES = [
  {
    ...
    warm: [
      (g, e) => `最近你${e},听你随口一提都能听出累。这件${g}帮不了大忙,但愿意能接住你一点点。`,
      (g, e) => `知道你${e}的事。送你这件${g}——不为别的,就为你能在某个时刻把脖子放松一秒。`,
      (g, e) => `${e}这几个字听着轻,扛着却重。这件${g}给你,别再硬扛了。`,
    ],
    witty: [
      (g, e) => `听说你又在${e}。这件${g}送你——不送“加油”,只送“先别把自己逼太紧”。`,
      (g, e) => `${e}的人不配收礼?偏不。这件${g}你拿好,公司不会感谢你,但我可以。`,
      (g, e) => `专治${e}综合征:${g}一件。功效见疗程,无效退我。`,
    ],
  },
  {
    keys: ["失眠", "睡不着", "多梦", "黑眼圈", "熬夜"],
    warm: [
      (g, e) => `你说最近${e}。这件${g},愿意你夜里能踏实地休息几个钟头。`,
      (g, e) => `${e}的夜晚最难熬。这件${g}送你,愿它陪你过几个安静的夜。`,
      (g, e) => `知道你${e}很久了。这件${g}不是解药,只是想让你知道有人记得。`,
    ],
    witty: [
      (g, e) => `${e}这种事,光靠意志力扛不住。这件${g}先拿去试试,不行再回来骂我。`,
      (g, e) => `${e}的解决方案有三种:运动、冥想、和这件${g}。前两个你做不到,第三个我替你买了。`,
    ],
  },
  {
    keys: ["颈椎", "肩颈", "腰痛", "背痛", "鼠标手", "腱鞘"],
    warm: [
      (g, e) => `一身的${e},是你为这些年扛下来的成本。这件${g},替我跟你说一句“辛苦了”。`,
      (g, e) => `你这${e},不是一两天的事了。这件${g}送你,别再说“等忙完再去看”。`,
      (g, e) => `${e}这件事你自己提过好几次。这次别拖,先用上这件${g}。`,
    ],
    witty: [
      (g, e) => `你这${e},你的人体工学里大概只剩“坐”这一个动作了。${g}出场,后面靠你了。`,
      (g, e) => `${e}是工龄的副作用。这件${g}是我的微小贡献,先用着,别等到去医院再想起我。`,
    ],
  },
  {
    keys: ["考研", "考公", "复习", "考试", "雅思", "考研人", "上岸"],
    warm: [
      (g, e) => `你为${e}拼了这么久。这件${g},陪你走到下一个里程碑。`,
      (g, e) => `${e}这条路不好走。这件${g}没什么大用,就当我替你点的一盏灯。`,
      (g, e) => `知道你最近全在${e}上。这件${g}给你,不催你,只陪着。`,
    ],
    witty: [
      (g, e) => `${e}期间不能乱送礼,怎么办?那就送件不乱的——${g}。你只负责上岸。`,
      (g, e) => `${e}人专属:这件${g}许愿用,真的没用就当摆件。`,
    ],
  },
  {
    keys: ["减肥", "健身", "减脂", "跑步", "骑行", "瑜伽", "撸铁"],
    warm: [
      (g, e) => `看你坚持${e}这么久,挺受鼓舞的。这件${g}送你,算我加油的一部分。`,
      (g, e) => `${e}不是件容易的事。这件${g}给你,算是同道中人的小小敬意。`,
    ],
    witty: [
      (g, e) => `你们这些${e}的人最难送礼。送吃的怕你纠结,不送吃的又怕你说“什么都不缺”。那就这件${g}。`,
      (g, e) => `${e}打卡的第无数天,这件${g}送你。请勿用它当作不练的借口。`,
    ],
  },
  {
    keys: ["猫", "狗", "养狗", "养猫", "主子", "铲屎", "毛孩子"],
    warm: [
      (g, e) => `都说${e}的人身上能看出他还留着多少软。这件${g},是送你们两位的。`,
      (g, e) => `${e}的人,日子总是有声音的。这件${g}送你,愿你们都好。`,
    ],
    witty: [
      (g, e) => `主要是看${e}比你过得好。这件${g}是为你买的——不准转赠毛孩子。`,
      (g, e) => `${e}的家里物件总会神秘失踪。这件${g}请妥善保管,出事别找我。`,
    ],
  },
  {
    keys: ["咖啡", "手冲", "拿铁", "美式", "豆子", "V60", "挂耳"],
    warm: [
      (g, e) => `你恋上${e}是从什么时候开始的我都记得。这件${g},算它加入你的仪式感。`,
      (g, e) => `${e}这件事你一聊就是半小时。这件${g}送你,凑个趣。`,
    ],
    witty: [
      (g, e) => `你这个${e}狂热分子。这件${g}安排上,记得“人比豆子香”。`,
      (g, e) => `送${e}爱好者最怕送错。这件${g}保底——它和${e}没有任何风味冲突。`,
    ],
  },
  {
    keys: ["追剧", "看剧", "追星", "演唱会", "粉丝", "爱豆"],
    warm: [
      (g, e) => `你说你${e}的时候只会“啊啊啊”。这件${g}是给那些“啊啊啊”留的位置。`,
      (g, e) => `${e}是这段日子里你最快乐的那部分。这件${g}陪你继续快乐。`,
    ],
    witty: [
      (g, e) => `看在你${e}不在线的面子上,送你这件${g}。下次安利记得喊我。`,
      (g, e) => `${e}的人最不需要劝。这件${g}送你,我懂的,你继续。`,
    ],
  },
  {
    keys: ["旅行", "出差", "新城市", "搬家", "异地", "出国"],
    warm: [
      (g, e) => `要${e}了。这件${g}装进行李里,愿意你到哪儿都能快一点安顿下来。`,
      (g, e) => `${e}总要带点能让你安心的东西。这件${g}算一个。`,
    ],
    witty: [
      (g, e) => `你又${e}。这件${g}可以随身,是你行李里比较不占位置又比较有用的那个。`,
      (g, e) => `${e}前的最后一份礼物。请保护好它,以及你自己。`,
    ],
  },
  {
    keys: ["生日", "生辰"],
    warm: [
      (g, e) => `生日快乐。这件${g},代表这一年我看见你的那部分。`,
      (g, e) => `生日快乐。礼物挑了挺久,最后选了这件${g}——你应该会懂的。`,
    ],
    witty: [
      (g, e) => `生日快乐。礼物是这件${g}——你随便拆,反正它不会跑。`,
      (g, e) => `生日只许愿不还愿的人没资格收礼。但你例外——这件${g}给你。`,
    ],
  },
  {
    keys: ["离职", "裸辞", "gap", "间隔年", "转行", "转职", "辞职"],
    warm: [
      (g, e) => `${e}这件事我听说了。不说加油,也不说“你想清楚没”,只是这件${g}是我能给的那部分。`,
      (g, e) => `${e}之后这段空隙,不容易。这件${g}给你,慢慢来。`,
    ],
    witty: [
      (g, e) => `${e}是个重量级决定,这件${g}是个轻量级礼物。以轻接重,三餐随你。`,
  ...
  },
  {
    ...
    warm: [
      (g, e) => `${e}了,送你这件${g}。新位置上的第一阵风总是冷的,愿意它能挡一挡。`,
      (g, e) => `恭喜${e}。这件${g}给你,愿它陪你一起把新角色穿合身。`,
    ],
    witty: [
      (g, e) => `${e}就要有${e}的样子。这件${g}你拿好,先把行头补齐再卷。`,
      (g, e) => `${e}礼物,别太喜庆。这件${g}低调又有用,跟你新名片很配。`,
    ],
  },
  {
    keys: ["分手", "失恋", "前任"],
    warm: [
      (g, e) => `${e}的事我不多问。这件${g}送你,什么时候用它由你说了算。`,
      (g, e) => `${e}之后这段路你自己走,但我能陪一段算一段。这件${g}先收下。`,
    ],
    witty: [
      (g, e) => `${e}这种事我懂的不多,礼物倒是会挑。这件${g},别拿来砸前任。`,
      (g, e) => `${e}专属:这件${g}不解恨,但能转移注意力。`,
    ],
  },
];
