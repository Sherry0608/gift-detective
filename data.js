...
const GIFTS = [
  ...
  // ===== 潮流/新奇/小众 =====
  { name: "设计师联名帆布包", searchQuery: "设计师联名 帆布包", price: 480, emoji: "👜",
    tags: ["设计","潮流","穿搭","包"],
    personas: ["EMLW","EALW","EARW","EALS"],
    relations: ["lover","friend","crush"],
    reason: "小众但不冷门，TA 背出门会被同温层秒认出来。" },
  { name: "热气球/陶艺/调香体验券", searchQuery: "陶艺体验券 礼物", price: 680, emoji: "🎈",
    tags: ["体验","新奇","旅行","尝试","课程"],
    personas: ["EMLW","EALW","EARW","IALW"],
    relations: ["lover","friend","crush"],
    reason: "比起一个物件，TA 更想要一段能讲一年的故事。" },
  { name: "潮玩盲盒大礼包", searchQuery: "潮玩盲盒 礼盒", price: 360, emoji: "🧸",
    tags: ["盲盒","收藏","治愈","摆件","可爱"],
  ...
  // ===== 体面/职场/轻奢 =====
  { name: "轻奢真皮卡包", searchQuery: "真皮卡包 轻奢", price: 880, emoji: "👛",
    tags: ["皮具","职场","通勤","穿搭"],
    personas: ["EMRS","IMRS","EARS","IARS"],
    relations: ["lover","family","colleague"],
    reason: "出现在 TA 工位上的每一个物件，都是 TA 自我介绍的一部分。" },
  { name: "进口品牌钢笔", searchQuery: "钢笔 进口 商务礼盒", price: 1280, emoji: "🖋️",
    tags: ["书写","职场","签字","笔"],
    personas: ["EMRS","IMRS","IARS"],
    relations: ["lover","family","colleague"],
    reason: "一支会跟着 TA 签下很多重要时刻的笔。" },
  { name: "沙龙香水（小众款）", searchQuery: "沙龙香水 小众 礼盒", price: 1080, emoji: "🌸",
    tags: ["香水","香氛","气味","穿搭"],
  ...
  // ===== 慢生活/家 =====
  { name: "桌面园艺小盆栽套装", searchQuery: "桌面盆栽 礼物", price: 180, emoji: "🪴",
    tags: ["植物","园艺","治愈","居家","绿色"],
    personas: ["IALS","EALS","IMLS","IARS"],
    relations: ["friend","family","colleague","crush"],
    reason: "TA 喜欢照顾的东西，又多一个。" },
  { name: "手工陶瓷餐具一人份套组", searchQuery: "手工陶瓷餐具 一人份", price: 480, emoji: "🍽️",
    tags: ["陶瓷","餐具","做饭","居家","美食"],
    personas: ["IALS","EALS","IARS","IMLS"],
    relations: ["lover","family","friend"],
    reason: "TA 一个人吃饭也想要好好吃饭。" },
  { name: "手冲咖啡入门套装", searchQuery: "手冲咖啡 入门套装", price: 580, emoji: "☕",
    tags: ["咖啡","手冲","居家","早晨","治愈"],
  ...
  // ===== 二次元/游戏/赛博 =====
  { name: "Steam 数字礼品卡", searchQuery: "Steam 礼品卡", price: 300, emoji: "🎮",
  ...
  { name: "限量手办 / 周边盲盒", searchQuery: "限量手办 盲盒", price: 480, emoji: "🗿",
    tags: ["手办","周边","二次元","收藏","盲盒"],
    personas: ["IALW","EMRW","IARW","IMLW"],
    relations: ["lover","friend","crush"],
    reason: "TA 的桌面博物馆，又多一件镇馆之宝。" },
  { name: "像素风 LED 桌面摆件", searchQuery: "像素 LED 桌面摆件", price: 220, emoji: "🕹️",
    tags: ["桌面","摆件","像素","赛博","灯"],
  ...
  // ===== 100 元以下补充 =====
  { name: "手工香薰小蜡烛", searchQuery: "手工香薰蜡烛", price: 58, emoji: "🕯️",
    tags: ["香薰","焦虑","助眠","治愈","居家"],
    personas: ["IMLS","IALS","IMLW","EALS","IARS"],
    relations: ["lover","friend","colleague","family","crush"],
    reason: "深夜点一枚，帮 TA 把一整天的紧绷轻轻化掉。" },
  { name: "云朵棉眼罩（热敷款）", searchQuery: "蒸汽眼罩 热敷", price: 68, emoji: "😴",
  ...
  { name: "手冲单品咖啡豆 250g", searchQuery: "单品咖啡豆 250g", price: 88, emoji: "☕",
    tags: ["咖啡","手冲","早餐","品质","生活"],
    personas: ["IMRS","EMRS","IMLW","IARS","EARS","IALS"],
    relations: ["colleague","friend","family","lover"],
    reason: "不是贵礼物，但 TA 每个早上都会谢你一次。" },
  { name: "口袋打卡小本 · 一年交换", searchQuery: "口袋本 交换日记", price: 78, emoji: "📒",
